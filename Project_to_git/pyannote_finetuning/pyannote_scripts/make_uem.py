    ...
    for filename in sorted(os.listdir(input_dir)):
        ...
        with open(file_path, 'r') as f:
            ...
            if lines:  # some files are empty...?
                first = lines[0]
                last = lines[-1]
                tbeg = int(first.split()[0])  # get the start time of first line
                tend = int(last.split()[1])  # get the end dur of last line
                new_line = f'{file_stem} NA {tbeg / (10 ** 7):.3f} {tend / (10 ** 7):.3f}\n'
